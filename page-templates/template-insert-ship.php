                ...
                <article class="post single clearfix">
                  ...
                  <div class="image-wrapper">
                        ...
                        foreach ($ship_information as $key => $value) :
                          ...
                          if( $current_index % 2 === 0 ){
                            if( $current_index === count($ship_information) - 1 ){
                              $content .=
                                "<tr><th><label for='$key'>$value</label></th><td><input type='text' name='$key' /></td><td></td><td></td></tr>";
                            } else {
                              $content .=
                                "<tr><th><label for='$key'>$value</label></th><td><input type='text' name='$key' /></td>";
                            }
                          } elseif( $current_index % 2 === 1 ) {
                            $content .=
                              "<th><label for='$key'>$value</label></th><td><input type='text' name='$key' /></td></tr>";
                          }
                        ...
                        foreach ($ship_option_basic as $key => $value) {
                            ...
                            if( $current_index % 2 === 0 ){
                              if( $current_index === count($ship_option_basic) - 1 ){
                                $content .=
                                  "<tr><td class='value'><label for='$key'>$value</label></td><td><input type='checkbox' value='{$value}' {$key_attr} /></td><td></td><td></td></tr>";
                              } else {
                                $content .=
                                  "<tr><td class='value'><label for='$key'>$value</label></td><td><input type='checkbox' value='{$value}' {$key_attr} /></td>";
                              }
                            } elseif( $current_index % 2 === 1 ) {
                              $content .=
                                "<td class='value'><label for='$key'>$value</label></td><td><input type='checkbox' value='{$value}' {$key_attr} /></td></tr>";
                            }
                    ...
                    <div class="ship-desc-wrapper">
                      ...
                      <div class="ship-desc">
                        <textarea name="ship-desc" rows="8" cols="80">
                          <?php the_content(); ?>
                        </textarea>
                      </div>
                    </div>
