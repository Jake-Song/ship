...
<div id="login-register-password">
  ...
  if (!$user_ID) { ?>
  	...
  	<div class="tab_container_login">
          ...
          $register = ( !empty($_GET['register']) ) ? $_GET['register'] : false;
          $reset = ( !empty($_GET['reset']) ) ? $_GET['reset'] : false;
		...
		<div id="tab2_login" class="tab_content_login" style="display:none;">
			...
			<form method="post" action="<?php echo site_url('wp-login.php?action=register', 'login_post') ?>" class="wp-user-form">
				...
				<div class="login_fields">
					...
					<?php $register = ( !empty($_GET['register']) ) ? $_GET['register'] : false; if($register == true) { echo '<p>Check your email for the password!</p>'; } ?>
		...
		<div id="tab3_login" class="tab_content_login" style="display:none;">
			...
			<form method="post" action="<?php echo site_url('wp-login.php?action=lostpassword', 'login_post') ?>" class="wp-user-form">
				...
				<div class="login_fields">
					...
					<?php $reset = ( !empty($_GET['reset']) ) ? $_GET['reset'] : false; if($reset == true) { echo '<p>A message will be sent to your email address.</p>'; } ?>
